...
fn read_clipboard_tool(args: Value, paths: MossPaths) -> Result<String> {
...
fn auto_result(paths: MossPaths) -> Result<String> {
    detected_text_result(paths)
}

fn detected_text_result(paths: MossPaths) -> Result<String> {
...
fn image_binary_result(img: crate::clipboard::ClipboardImage, paths: &MossPaths) -> Result<String> {
